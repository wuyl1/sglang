...
class ServerArgs:
    ...
    def describe_kv_events_publisher(self) -> Optional[dict]:
        ...
        * the endpoint is not a routable TCP address (inproc:// /
        ...
        snapshot_model = self.served_model_name or self.model_path
        descriptor = {
            "publisher": publisher,
            "endpoint_host": host,
            ...
            "worker_id": f"{snapshot_model}@{self.host}:{self.port}",
            "hash_schema_version": 1,
            "is_bigram": str(self.speculative_algorithm or "").lower()
